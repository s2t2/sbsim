...
load_dotenv() # use environment variables specified in the .env file
...
VIDEO_PATH_ROOT = os.getenv("VIDEO_PATH_ROOT", default="/cns/oz-d/home/smart-buildings-control-team/smart-buildings/geometric_sim_videos/")  # pylint: disable=line-too-long
